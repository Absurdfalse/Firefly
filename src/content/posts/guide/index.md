...
Hello啊，这是我的第一个博客。
这个博客是基于 [Astro](https://astro.build/) 构建的。如果你也想构建自己的博客，可以参考[Astro 文档](https://docs.astro.build/) 。下面是我发布博客文章时定义数据的一些方法。
...
title: 如何使用博客
published: 2026-06-30
slug: how-to-use-blog
---
```
文件：`src/content/posts/如何使用博客.md`

URL：`/posts/how-to-use-blog`
